...
namespace PhoneSkill
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var botConfig = BotConfiguration.Load(botFilePath ?? @".\PhoneSkill.bot", botFileSecret);
            ...
            var supportedLanguages = connectedServices.LocaleConfigurations.Keys.ToArray();
            ...
            services.AddBot<PhoneSkill>(options =>
            {
                // Load the connected services from .bot file.
